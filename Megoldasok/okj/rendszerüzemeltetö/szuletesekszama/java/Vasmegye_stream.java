...
public class Vasmegye_stream {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Csecsemők száma: " + szuletesek.length);
        System.out.println("6. Feladat");
        System.out.println("Fiú csecsemők száma: " + Arrays.stream(szuletesek).filter(k -> k.szamjegyek[0] % 2 == 1).count());
        System.out.println("7. Feladat");
        
        var stat = Arrays.stream(szuletesek).mapToInt(k -> k.datum.getYear()).summaryStatistics();
        System.out.println("Vizsgált időszak: Kezdet: " + stat.getMin() + ", vége: " + stat.getMax());
        
        System.out.println("8. Feladat");
        Arrays.stream(szuletesek)
              .filter(k -> k.datum.getYear() % 4 == 0)
              .findFirst()
              .ifPresent(k -> System.out.println("Volt baba szökőévben"));
    ...
    public static class Szuletes{
        ...
        public Szuletes(String line) {
            ...
            datum = LocalDate.of(Integer.parseInt((szamjegyek[0] < 3 ? "19" : "20") + split[1].substring(0, 2)), //Év az alapján h 3-nál kisebb v nagyobb e az első szám
